...
public interface IVcuController extends ILifeCycle {
    ...
    float getBmsCurrentBatterySocDisp() throws Exception;

    int getBreakTravel() throws Exception;

    int getBreakTravelValidateFlag() throws Exception;
    ...
    int getDriveTravelValidateFlag() throws Exception;

    int getDriverOverride() throws Exception;

    int[] getDtcPageAndEdvBhvilop() throws Exception;
    ...
    int getIpuStateGearLevel() throws Exception;

    int getMainPowerRelayState() throws Exception;

    int getMainRelayCloseRequest() throws Exception;
    ...
    int getRealGearLevel() throws Exception;
