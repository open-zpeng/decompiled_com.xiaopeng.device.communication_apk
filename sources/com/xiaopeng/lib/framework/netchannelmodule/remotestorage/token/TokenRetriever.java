...
public final class TokenRetriever {
    ...
    public class GetTokenCallback implements Callback {
        ...
        public void onFailure(IResponse iResponse) {
            ...
            c.f(TokenRetriever.TAG, "Request token error! the error message---->" + iResponse.message());
    ...
    public void callFailureCallbacks(final StorageException storageException) {
        i.i(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.token.TokenRetriever.2
    ...
    public void callSuccessCallbacks(final Token token) {
        i.i(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.token.TokenRetriever.1
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void clearToken() {
        this.mToken = null;
        c.a(TAG, "Clear the existing token!");
    }
