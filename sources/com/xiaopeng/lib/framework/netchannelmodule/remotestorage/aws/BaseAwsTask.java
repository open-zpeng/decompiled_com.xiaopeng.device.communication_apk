...
public abstract class BaseAwsTask implements Runnable {
    ...
    public void doFailure(StorageException storageException) {
        c.a(TAG, "Failed! Reason is-->" + storageException.getMessage());
    ...
    public String generateObjectKey(String str) {
        ...
        return this.mBucket + MqttTopic.TOPIC_LEVEL_SEPARATOR + str + MqttTopic.TOPIC_LEVEL_SEPARATOR + b.e() + MqttTopic.TOPIC_LEVEL_SEPARATOR + a.c(currentTimeMillis) + MqttTopic.TOPIC_LEVEL_SEPARATOR + g.g() + MqttTopic.TOPIC_LEVEL_SEPARATOR + currentTimeMillis + ".zip";
    }
