...
public final class StorageCounter implements Handler.Callback {
    ...
    private void debugInfo() {
        if (DEBUG) {
            b.d.b.e.c.s(TAG, "[RemoteStorage] Request:" + this.mRequestCount.get() + " Failed:" + this.mFailedCount.get() + " Succeed:" + this.mSucceedCount.get() + " Size(KB):" + this.mTrafficSize.get() + " ErrorCodes:" + getErrorCodesInString() + " Package:" + GlobalConfig.getApplicationSimpleName() + " Net:" + GlobalConfig.getNetworkType());
        }
    }
    ...
    */
    ...
    public static boolean isInternationVersion() {
        boolean c2 = c.c();
        Log.i("netChannel", "isInternationVersion :\t" + c2);
        return c2;
    }
    ...
    private StorageCounter() {
        this.mExceedTrafficQuota = false;
        this.mHandler = new Handler(i.g(0), this);
    }
}
