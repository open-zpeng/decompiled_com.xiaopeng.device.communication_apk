...
public class MqttChannel {
    ...
    public class MqttCallbackImpl implements MqttCallbackExtended {
        ...
        public void deliveryComplete(IMqttDeliveryToken iMqttDeliveryToken) {
            if (b.j()) {
                ...
                try {
                    ...
                    c.a("NetChannel-MqttChannel", "Delivered completely, but met exception while getting message:" + e);
                }
            }
        ...
        public void messageArrived(String str, MqttMessage mqttMessage) {
            c.a("NetChannel-MqttChannel", "messageArrived: topic = " + str);
        ...
        private SchedulerClient() {
            ...
            this.mUnexpectedHandlingAction = new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.SchedulerClient.3
                ...
                public void run() {
                    ...
                    c.a("NetChannel-MqttChannel", "mUnexpectedHandlingAction: connected state = " + MqttChannel.this.mScheduler.connected() + ", " + MqttChannel.this.mMqttAndroidClient.isConnected());
            ...
            try {
                ...
                this.mMqttAndroidClient.connect(this.mMqttConnectOptions, this.mApplicationContext, new IMqttActionListener() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.5
                    ...
                    public void onFailure(IMqttToken iMqttToken, Throwable th) {
                        ...
                        MqttChannel.this.mScheduler.moveTo(Scheduler.STATE.DISCONNECTED);
                        c.a("NetChannel-MqttChannel", "connectMqtt failed! release connection resources in time");
                        try {
    ...
    private boolean initAndroidClientSuccess() throws MessagingException {
        c.l("NetChannel-MqttChannel", "initAndroidClientSuccess mMqttAndroidClient = " + this.mMqttAndroidClient);
    ...
    public void log(String str) {
        c.l("NetChannel-MqttChannel", str);
    }
    ...
    public boolean networkAvailable() {
        if (e.d(this.mApplicationContext)) {
            return !e.c(this.mApplicationContext) || e.e();
        }
        return false;
    }
            ...
            public void run() {
                try {
                    if (MqttChannel.this.networkAvailable()) {
                        ...
                        c.a("NetChannel-MqttChannel", "Network is not available, delay to try...");
                    }
                } catch (Exception e) {
                    MqttChannel.this.log(e.toString());
                    e.printStackTrace();
