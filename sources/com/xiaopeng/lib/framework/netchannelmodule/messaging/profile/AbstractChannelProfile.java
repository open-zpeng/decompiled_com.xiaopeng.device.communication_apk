...
public abstract class AbstractChannelProfile {
    ...
    static {
        ...
        SYSTEM_PROPERTY_MQTT_USER = "persist.sys.mqtt.user" + b.a();
        SYSTEM_PROPERTY_MQTT_PASS = "persist.sys.mqtt.pass" + b.a();
        SYSTEM_PROPERTY_MQTT_ID = "persist.sys.mqtt.id" + b.a();
        SYSTEM_PROPERTY_MQTT_REPORTING_URL = "persist.sys.mqtt.url" + b.a();
        SYSTEM_PROPERTY_MQTT_COMM_URL = "persist.sys.mqtt.comm_url" + b.a();
        SYSTEM_PROPERTY_MQTT_COMM_ID = "persist.sys.mqtt.comm_id" + b.a();
        SYSTEM_PROPERTY_MQTT_COMM_USER = "persist.sys.mqtt.comm_user" + b.a();
        SYSTEM_PROPERTY_MQTT_COMM_PASS = "persist.sys.mqtt.comm_pass" + b.a();
    }
    ...
    private static boolean checkDebuggingFlag() {
        return b.g() && new File(DEBUG_FLAG_FILE).exists();
    }
    ...
    */
    ...
    public MqttConnectOptions buildConnectOptions() {
        ...
        mqttConnectOptions.setMaxInflight(MAX_INFLIGHT);
