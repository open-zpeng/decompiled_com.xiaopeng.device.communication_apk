        ...
        if (i != this.length) {
            ...
            if (c2 != ' ' && c2 != '%' && c2 != '\\' && c2 != '_' && c2 != '\"' && c2 != '#') {
                switch (c2) {
                    ...
                    default:
                        switch (c2) {
                            case R.styleable.AppCompatTheme_dividerHorizontal /* 59 */:
                            case '<':
                            case R.styleable.AppCompatTheme_dropDownListViewStyle /* 61 */:
                            case R.styleable.AppCompatTheme_dropdownListPreferredItemHeight /* 62 */:
                                break;
                            default:
                                return getUTF8();
                        }
