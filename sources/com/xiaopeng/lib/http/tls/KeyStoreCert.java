    ...
    public static SSLSocketFactory getTLS2SocketFactory() {
        ...
        try {
            ...
            if (!compositeX509TrustManager.isHasValidCert()) {
                b.b().a(IpcConfig.AfterSalesConfig.IPC_REQUEST_REPAIRMODE_STATUS, "no valid ssl factory");
            }
            ...
            b.b().a(IpcConfig.AfterSalesConfig.IPC_REQUEST_REPAIRMODE_STATUS, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static X509TrustManager getX509TrustManager() {
        try {
            ...
            if (!compositeX509TrustManager2.isHasValidCert()) {
                b.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_REQUEST, "no valid trust manager");
            }
            return compositeX509TrustManager2;
        } catch (Exception e) {
            b.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_REQUEST, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
