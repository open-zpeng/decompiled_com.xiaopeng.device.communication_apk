...
public class LocalFileCert {
            ...
            if (keyManagerArr == null) {
                try {
                    if (SecurityCommon.checkSystemUid(context)) {
                        c.l(TAG, "get cert content from file");
                        certificate = FileUtils.readTextFile(new File(CERT_PATH), 0, null);
                    } else {
                        c.l(TAG, "get cert content from SystemDelegate");
                    ...
                    c.u(TAG, "getKeyManagers error!", e2);
                    return null;
                }
            }
        }
    ...
    public static SSLSocketFactory getTLS2SocketFactory(Context context) {
        try {
            ...
            b.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_MAP_GAODE_LOG, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            b.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_RESPONSE, e.getLocalizedMessage());
                            e.printStackTrace();
                        }
                        try {
                            open.close();
                    ...
                    b.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_RESPONSE, e2.getLocalizedMessage());
                    e2.printStackTrace();
                    return null;
                }
            }
