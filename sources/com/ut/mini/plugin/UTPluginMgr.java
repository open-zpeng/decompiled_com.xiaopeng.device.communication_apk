...
public class UTPluginMgr implements UTMCAppStatusCallbacks {
    ...
    private static UTPluginMgr f2166a = new UTPluginMgr();

    /* renamed from: b  reason: collision with root package name */
    private HandlerThread f2167b = null;
    ...
    private void K() {
        ...
        this.f2167b = handlerThread;
        handlerThread.start();
        this.mHandler = new Handler(this.f2167b.getLooper()) { // from class: com.ut.mini.plugin.UTPluginMgr.2
