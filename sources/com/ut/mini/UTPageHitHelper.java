...
public class UTPageHitHelper {
    ...
    private static UTPageHitHelper f2151a = new UTPageHitHelper();
    ...
    private synchronized void m67b(Object obj) {
        String m66a = m66a(obj);
        if (this.A.containsKey(m66a)) {
            this.A.remove(m66a);
        }
    }
    ...
    private String m66a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m69a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m68a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m66a = m66a(obj);
        if (this.A.containsKey(m66a)) {
            return this.A.get(m66a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m66a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m66a);
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m66a = m66a(obj);
            if (m66a != null && m66a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
