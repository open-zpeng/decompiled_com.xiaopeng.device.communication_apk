...
public class UTHybridHelper {
    ...
    private static UTHybridHelper f2150a = new UTHybridHelper();
    ...
    */
    ...
    private void a(Date date, Map<String, String> map) {
        ...
        String b2 = b(map.get("urlpagename"), map.get("url"));
        if (b2 != null && !TextUtils.isEmpty(b2)) {
            ...
            if (str != null && !TextUtils.isEmpty(str)) {
                ...
                UTOriginalCustomHitBuilder uTOriginalCustomHitBuilder = new UTOriginalCustomHitBuilder(b2, 2101, str, null, null, map2);
            ...
            i.d("h5Ctrl", "logkey is null,return");
            return;
        }
        i.d("h5Ctrl", "pageName is null,return");
    }
}
